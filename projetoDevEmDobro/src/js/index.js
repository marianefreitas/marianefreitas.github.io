...
itens.forEach((item) => {
  item.addEventListener("mouseenter", () => {
    ...
    imagemItemGrande.src = `./src/imagens/${idItem}.png`;

    const nomeItem = document.getElementById("nome-item");

    nomeItem.innerText = item.getAttribute("data-name");

    const descricaooItem = document.getElementById("descricao-item");

    descricaooItem.innerText = item.getAttribute("data-description");
